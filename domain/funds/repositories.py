...
class FundRepository:
    def __init__(self):
        self.subscriptions = []
        self.funds = [
            Fund(id=1, name="FPV_BTG_PACTUAL_RECAUDADORA", category="FPV", min_investment=75000),
            Fund(id=2, name="FPV_BTG_PACTUAL_ECOPETROL", category="FPV", min_investment=125000),
            ...
            Fund(id=5, name="FPV_BTG_PACTUAL_DINAMICA", category="FIC", min_investment=100000)
        ]
